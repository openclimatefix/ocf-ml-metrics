...
def evaluation(
    ...
    **kwargs,
    ...
    print('Making metrics on normalized')
    ...
    print('Making metrics on baselines')
...
def evaluation_per_id(
    ...
    **kwargs,
    ...
    ids = results_df["id"].unique()
    if len(ids) == 1:
        print("Only one ID, skipping per ID evaluation")
    else:
        for id in ids:
            print(id)
