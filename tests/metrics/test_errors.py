...
def test_compute_error_part_of_year():
    ...
    errors = compute_metrics_part_of_year(predictions=predictions, target=target, datetimes=datetimes)
...
def test_compute_error_part_of_day():
    ...
    errors = compute_metrics_part_of_day(predictions=predictions, target=target, datetimes=datetimes)
    for key in errors.keys():
